  ...
  render() {
    return (
      <div className="content prop_2">
        ...
        <figure>
          <a href="./images/screenshot/layout_searchbar.png"><img src="./images/screenshot/layout_searchbar.png" alt=""/></a>
        ...
        <div className="p figset">
          <figure>
            <a href="./images/screenshot/layout_cutted.png"><img src="./images/screenshot/layout_cutted.png" alt=""/></a>
            <figcaption>세로 586px 해상도에서 짤리는 영역</figcaption>
          </figure>
          <figure>
            <a href="./images/screenshot/layout_height.png"><img src="./images/screenshot/layout_height.png" alt=""/></a>
        ...
        <figure>
          <a href="./images/screenshot/layout_login.png"><img src="./images/screenshot/layout_login.png" alt=""/></a>
